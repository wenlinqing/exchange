<template>
	<view class="container"><!-- :class="getThemeType" -->
		<status-bar background="#20D39D"></status-bar>
		<topNav bgColor="transparent" textColor="#fff" backIcon="white" title="收款码" :isToTop="true" style="color:#fff"></topNav>
		...
		<view class="button" @click="saveImage">保存收款码</view>
...
<script>
	...
	export default {
		data() {
			return {
				addressText: '0xb2712230a1e1f9bf77e9a124bc081c67a14607b7',
				address: '0xb2712230a1e1f9bf77e9a124bc081c67a14607b7',
				width:350,
				height:470,
				ewmUrl:'',
				imgurl:''
		...
		methods: {
			canvasImage(){
				...
				grd.addColorStop(0, '#20D39D')
				grd.addColorStop(1, '#15B383')
...
<style>
.container{width:100vw;height:100vh;background:linear-gradient(180deg,#20D39D 0,#15B383 100%);overflow: hidden;}
...
justify-content:center;font-size:17px;color:#15B383;background-color:#fff;height:44px;border-radius:5px}
...
.dark .button {background-color: #20D39D;color: #fff;}
</style>
